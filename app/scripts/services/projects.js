		...
		return {
			...
			list: [
			    ...
			    new Project({
			    	...
			    	description: 'MY11.com White label predictor game',
			    ...
			    new Project({
			    	...
			    	title: 'YOA BPM',
			    	img: 'images/yoa.png',
			    	description: 'YOA Sales process, a proven workflow that increased sales by 20%',
			    	position: 'Web Developer',
			    	issueManagement: 'BASECAMP',
			    	sourceControl: 'GIT',
			    	additionalSkills: ['PHP', 'PROCESSMAKER']
			    }),
			    new Project({
			    	id: 'm2',
			    	title: 'My11.com', 
			    	img: 'images/my11.png',
			    	url: 'http://www.my11.com',
			    	description: 'MY11.com worldwide fantasy football game site!',
			    	position: 'Web developer',
			    	role: '',
			    	issueManagement: 'BASECAMP',
			    	sourceControl: 'MERCURIAL',
